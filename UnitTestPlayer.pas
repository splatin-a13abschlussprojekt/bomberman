...
If (i=0) or (i>Settings.NumOfPlayers) then exit; // PR: Abbruch, falls ungültige Eingabe
    ...
    begin
      Case Field[Player[i].Position.X,Player[i].Position.Y].Content of // PR: unterschiedliches Verhalten je nach Inhalt des Zielfeldes
        empty,bombup,energyup,explosion,player01,player02,player03,player04:
          ...
          begin
            If Settings.SFX then sndPlaySound('Files\Sounds\itemcollect.wav', SND_ASYNC); //HS: Abspielen des Sounds "itemcollect"
