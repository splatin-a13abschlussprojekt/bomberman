...
uses UnitInterface, UnitCreateMenuObjects, Math, UnitTestPlayer;
    ...
    begin
     With PlayerSettings[i] do
      begin
       ...
       KeyUp:=   Playergroupbox[i].ControlPanel[1].Caption;
       KeyDown:= Playergroupbox[i].ControlPanel[2].Caption;
       KeyLeft:= Playergroupbox[i].ControlPanel[3].Caption;
       KeyRight:=Playergroupbox[i].ControlPanel[4].Caption;
       KeyBomb:= Playergroupbox[i].ControlPanel[5].Caption;
