...
begin
 ...
 with PlayerGroupbox[i].DragDropImage.Image do
  begin
   ...
   case i of
    1: begin
        Picture:=FormMenu.UfoblueImage.Picture;//farbe wird gespeichert
        PlayerGroupbox[i].DragDropImage.Color:='blue';  //Bild wird nur in den Arbeitsspeicher geladen
       end;
    2: begin
         Picture:=FormMenu.UfogreenImage.Picture;
        PlayerGroupbox[i].DragDropImage.Color:='green';
       end;
    3: begin
         Picture:=FormMenu.UforedImage.Picture;
        PlayerGroupbox[i].DragDropImage.Color:='red';
       end;
    4: begin
         Picture:=FormMenu.UfoyellowImage.Picture;
...
begin
 with SuddenDeathImage.CheckImage do
  begin
   ...
   Left:=10;
   Picture:=FormMenu.CheckboxUncheckedImage.Picture; //standardmäßig ausgeschaltet
  ...
  begin
   ...
   Top:=FormMenu.NumberOfPlayersLabel.Top-3;
   Left:=600;
    Picture:=FormMenu.CheckboxCheckedImage.Picture; //standardmäßig ausgeschaltet
